...
//
// Dosya Görev Tanımı : Kernel Nesneleri
// Dosya Yolu         : apps/system/compat/win32/kernel_objects.rs
...
//
// Açıklama:
//   Event, Mutex, Semaphore kernel nesneleri ve PEB/TEB kritik bölüm.
//
// Bağımlı Dosyalar:
...
// ─── Kernel Objects (Event, Mutex, Semaphore) ──────────────────
